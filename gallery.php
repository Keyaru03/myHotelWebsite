...
$deluxPrimeExpirationRegal = "2024-11-13 18:36:00";  // Your target date and time for Regal
    ...
    <div class="wrap">
        ...
        <div class="gallerys">
            ...
            <div class="gallery-grids">
                ...
                <div class="gallery-grid">
                    <img src="images/regular club.jpg" height="125px" width="450px" alt="">
        ...
        <script>
            ...
            function updateCountdownKing() {
                ...
                document.getElementById("KingSize").innerHTML = days + "d " + hours + "h " + minutes + "m " + seconds +
                    "s ";
            ...
            function updateCountdownQueen() {
                ...
                document.getElementById("queenSize").innerHTML = days + "d " + hours + "h " + minutes + "m " + seconds +
                    "s ";
            ...
            function updateCountdownImperial() {
                ...
                document.getElementById("Imperial").innerHTML = days + "d " + hours + "h " + minutes + "m " + seconds +
                    "s ";
            ...
            function updateCountdownExecutive() {
                ...
                document.getElementById("Executive").innerHTML = days + "d " + hours + "h " + minutes + "m " + seconds +
                    "s ";
